...
import { Folder, CheckCircle2, Calculator, Settings, Moon, Sun } from 'lucide-react'
          ...
          {NAV_ITEMS.map(({ id, icon: Icon, label }) => {
            ...
            return (
              <button
                ...
                className={`h-9 inline-flex items-center gap-sm px-sm rounded-md transition-colors text-sm font-medium ${
                  active
