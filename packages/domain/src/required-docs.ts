...
const SPECS: Record<string, RequiredDocSpec[]> = {
  ...
  '우즈베키스탄': vietnamFamilyDocSpecs('우즈베키스탄', 'uz', {
    exportQuarantineDoc: {
      ...
      description:
        // '국경 도착 후 4시간 이내'도 폐지 법령 문언이라 뺐다 — 현행 §48 의 4시간은
        // '발급 결정 후 교부까지'로 의미가 다르다. 대신 실무상 중요한 7영업일을 쓴다(§42).
        '우즈베키스탄 수출 검역 후 발급받아요.\n\n먼저 거주 지역 수의·축산개발국에서 수의소견서를 받으세요. 이것만으로는 출국할 수 없어요.\n\n그 서류로 출국 공항 국경수의검문소에서 최종 수의증명서를 발급받아요.\n\n심사에 영업일 7일이 걸리니 여유 있게 신청하세요.\n\n한국 입국 때 필요하니 원본을 잘 보관하세요.\n\n앱에 사본 이미지를 저장해두면 관련 정보를 확인할 때 편리해요.',
    },
  }),
  '캐나다': vietnamFamilyDocSpecs('캐나다', 'ca', {
    ...
    exportQuarantineDoc: {
      ...
      description:
        '캐나다 출국 전 검역기관(CFIA) 배서를 받아 준비해요.\n\n한국행 전용 서식이에요. 현지 동물병원에서 작성받은 뒤 CFIA 공식 수의사의 배서를 받아야 해요.\n\n캐나다는 반려동물 출국 시 자체 검역을 하지 않아요. 한국이 수출국 정부 증명을 요구해서 배서가 필요한 거예요.\n\n배서는 예약제예요. 온라인 결제를 예약일 3일 전까지 마쳐야 하고 수수료는 환불되지 않아요. 캐나다를 떠난 뒤에는 받을 수 없으니 반드시 출국 전에 마치세요.\n\n한국 입국 때 필요하니 원본을 잘 보관하세요.\n\n앱에 사본 이미지를 저장해두면 관련 정보를 확인할 때 편리해요.',
    },
  }),
  ...
  '브라질': vietnamFamilyDocSpecs('브라질', 'br', {
    ...
    exportQuarantineDoc: {
      ...
      source: '브라질 농축산 검역기관(VIGIAGRO)',
      description:
        '브라질 수출 검역 후 발급받아요. 발급 비용은 없어요.\n\n현지 동물병원 건강증명서를 받아 VIGIAGRO에 신청하면 연방 농업감사관이 발급해요.\n\n한국은 전자 발급 대상이 아니라 직접 방문해야 하고 사전 예약이 필요해요. 마이크로칩을 발급 당일 현장에서 판독하니 칩이 반드시 있어야 해요.\n\n유효기간이 서명일로부터 10일뿐이니 일정을 맞추세요.\n\n한국 입국 때 필요하니 원본을 잘 보관하세요.\n\n앱에 사본 이미지를 저장해두면 관련 정보를 확인할 때 편리해요.',
    },
  }),
