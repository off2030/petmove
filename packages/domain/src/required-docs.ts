...
const SPECS: Record<string, RequiredDocSpec[]> = {
  ...
  '몽골': vietnamFamilyDocSpecs('몽골', 'mn', {
    ...
    exportQuarantineDoc: {
      ...
      source: '몽골 수의총국(GAVS)',
      description:
        // '1개월 유효'는 뺐다 — 국경검역법 25.4조의 **선적 전 24시간 이내 발급**이 우선이라,
        // 1개월만 쓰면 미리 받아도 된다고 읽힌다(카드 주석 참고).
        '몽골 수의총국(GAVS)에서 발급받아요. 한국 수출 검역증명서로 바로 발급되기도 하고, 현지 동물병원 확인서를 따로 요구하기도 해요.\n\n몽골어와 영어로 작성되고 2부를 받아요. 한 부는 보관하고 한 부는 출국 수속에 써요.\n\n출국 24시간 이내에 발급받아야 해요. 미리 받아두면 안 돼요.\n\n한국 입국 때 필요하니 원본을 잘 보관하세요.',
    },
  }),
