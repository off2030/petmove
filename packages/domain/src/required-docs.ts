  ...
  hawaii: [
    {
      ...
      kind: 'step',
      stepRef: 'rabies-titer',
      // 문형 = 싱가포르(검사기관 특이사항을 첫 문단에) + 공통 뼈대(발급처 → 용도·기간 → 앱
      // 보관). '0.5 IU/mL 합격'은 카드 설명이 담당(다른 목적지 결과지 설명에도 없음).
      // '원본 필요' 문장은 넣지 않는다 — 하와이는 검사기관이 결과를 검역소로 보내는 구조라
      // 타국의 '입국 때 원본 제시' 문형이 사실과 다를 수 있음.
      description:
        '검사를 의뢰한 동물병원을 통해 발급받아요. 검사는 미국 농무부(USDA) 승인 검사기관에서 이뤄져야 해요.\n\n하와이 입국 요건이에요. 검체가 검사기관에 도착한 날로부터 30일이 지난 후 36개월 이내에 입국해야 해요.\n\n앱에 사본 이미지를 저장해두면 검사 관련 정보를 확인할 때 편리해요.',
      previewStepId: 'rabies-titer',
    },
    US_CDC_FORM_RECEIPT,
    KR_FORM25_VACCINATION_HEALTH_CERT,
