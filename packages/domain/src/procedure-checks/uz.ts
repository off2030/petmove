...
export const UZ_CHECKS: ProcedureCheck[] = [
  {
    ...
    description:
      'ISO 표준 마이크로칩이 광견병 1차 접종일과 같거나 이전이어야 함. (우즈베키스탄 입국 권장, 한국 수출검역 사실상 필수)',
    severity: 'info',
    addedAt: '2026-05-07',
  ...
  {
    id: 'uz.rabies-prime-after-91days-old',
    country: COUNTRY,
    category: '광견병',
  ...
  },
  {
    ...
    description:
      '광견병 백신 면역 유효기간 1년만 인정. valid_until 이 접종일 + 1년(달력, 그날 포함) 초과면 거부. (1차 정부 명문 미확인 — 통념·관행상 12개월 기준, 보수 적용)',
    severity: 'blocker',
    addedAt: '2026-05-07',
    run: ({ caseRow, destination }) => {
      const rabies = readRabiesEntries(caseRow)
