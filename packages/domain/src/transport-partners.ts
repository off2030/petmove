 ...
 *
 * 전화번호·이메일은 **평문으로 렌더하지 않는다** — 버튼(tel:/mailto:)으로만 노출해서
 * 연락 시도를 셀 수 있게 한다. 목록 순서는 케이스마다 회전시켜 위치 편향을 없앤다 —
...
export const TRANSPORT_PARTNERS: readonly TransportPartner[] = [
  { slug: 'petairline', name: '펫에어라인', tel: '02-2667-0112', email: 'jeremy@petairline.co.kr' },
  { slug: 'worldpettour', name: '월드펫투어', tel: '02-6264-8288', email: 'petdrive@naver.com' },
]
