...
export const JOURNEY_STEP_CATALOG: StepDefinition[] = [
  ...
  },
  {
    ...
    // ⚠️ 아래 본문은 **사용자가 직접 불러준 문구 그대로**다(2026-07-22). 캄보디아와 같은 규칙 —
    //   안전문장 추가·동사 변경·문단 병합 금지. 2번째 덩어리의 '검진/임상검사'가 겹쳐 읽힌다고
    //   줄여 제안했으나 사용자가 원안을 택했다. 임의로 줄이지 말 것.
    ...
    description:
      '수출 검역을 받고 수의 증명서를 발급받으세요.\n\n현지 동물병원에서 검진 후 건강증명서를 받고 임상검사를 받고 접종 기록을 확인받으세요.\n\n최종 서류는 몽골 수의청(GAVS)이 발급하는 국제수의증명서예요. 동물병원 건강증명서만으로는 출국할 수 없어요.\n\n이 증명서는 선적 전 24시간 이내에 발급받아야 해요. 주말이나 이른 아침 출발이면 발급 시간과 장소를 미리 확인하세요.',
