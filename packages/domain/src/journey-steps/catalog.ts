...
export const JOURNEY_STEP_CATALOG: StepDefinition[] = [
  ...
  // '일반적으로'로 표현). 원문 확인되면 조정할 것.
  {
    ...
    shortLabel: '수출',
    description:
      '베트남 출국 전 지역 축산·수의지청(Chi cục Chăn nuôi và Thú y vùng)에서 수출 검역을 받으세요.\n\n출국하는 공항을 관할하는 지청에 미리 신청하세요. 공항에서 출국 당일 바로 받을 수 있는 절차가 아니에요.\n신청하면 지청이 검사 일시와 장소를 알려줘요. 반려동물과 원본 서류를 가지고 방문하세요.\n출국 5영업일 전까지 신청하는 것을 권해요.\n수출 검역증을 받으려면 현지 동물병원에서 먼저 건강증명서를 받아야 할 수 있어요. 신청할 때 지청에 확인하세요.\n검사를 통과하면 수출 동물검역증이 발급돼요. 한국 입국 때 이 서류가 필요해요.\n하노이 024-3869-2627 · 다낭 0236-3822-515 · 호치민 028-3983-0717',
    doneSummary: '베트남 수출 검역을 받았어요.',
    cardLine: '베트남 축산·수의지청에서 수출 검역을 받으세요.',
    ...
    // 전화번호 출처 = 베트남 수의국(Cục Thú y) 공식 '산하 기관' 페이지. 2026-07-20 대조 확인:
    //   Vùng I(하노이) 024.38692627 / Vùng IV(다낭) 02363822515 / Vùng VI(호치민) 08.39830717
    //   (호치민 08 은 옛 지역번호 — 현행 028 로 표기했다)
    // ⚠️ 나트랑(CXR)은 뺐다. 어느 지청 관할인지 공식 페이지에 안 나온다(Vùng VI 페이지에
    //   관할 성 목록이 없음). 확인되면 추가할 것 — 추측으로 넣으면 고객이 엉뚱한 곳에 연락한다.
    //   그래서 공식 목록 링크를 함께 둔다.
    links: [
      { url: 'https://cucthuy.gov.vn/cac-don-vi-thuoc-cuc', label: '지역 축산·수의지청 목록' },
    ],
  },
