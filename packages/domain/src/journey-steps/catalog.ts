...
export const JOURNEY_STEP_CATALOG: StepDefinition[] = [
  ...
  // ── 사전 신고 다음 — 일본 출국 검역 (왕복 케이스 한정) ──────────────
  {
    ...
    doneSummary: '일본 출국 검역 신청·예약을 완료했어요.',
    ...
    situational: (caseRow) => {
      ...
      const msg = '일본 출국 검역 신청·예약이 진행 중이에요. 예약이 확정되면 완료 버튼을 누르세요.'
      return { desc: msg, cardDesc: msg }
    },
    inputs: [
  ...
  // ── 13. 출국·도착 ──────────────────────────────────────────────────────
  {
    ...
    // base departure 는 첨부 불가 — 일본 override(일본 입국 검역)만 allowAttachments.
