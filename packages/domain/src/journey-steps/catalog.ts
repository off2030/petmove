...
export const JOURNEY_STEP_CATALOG: StepDefinition[] = [
  ...
  },
  {
    ...
    description:
      ...
      '카자흐스탄 출국 전 수출 검역을 받고 수출 수의증명서를 발급받으세요.\n\n먼저 현지 동물병원에서 출국 직전에 임상검사를 받고 수의여권 기록을 정리하세요.\n\n그 서류로 수의통제감독위원회 지역검사기관에 신청하면 최대 2영업일 안에 발급돼요. 신분증과 수의여권 사본이 필요하고, 증명서 발급 비용을 내야 해요.\n\n온라인 신청은 카자흐스탄 전자서명이 있어야 해서 보통 사무소를 방문해요. 출국 당일 공항에서 받으려 하지 말고 미리 발급받으세요.\n\n다른 지역에서 출발 공항으로 이동했다면 국내 수의증명서가 추가로 필요할 수 있어요.',
