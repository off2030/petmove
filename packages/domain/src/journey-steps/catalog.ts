...
export const JOURNEY_STEP_CATALOG: StepDefinition[] = [
  ...
  },
  {
    ...
    // ⚠️ links 없음 — 걸 만한 곳이 하나도 없다(2026-07-22 전수 확인).
    //   · inspection.gov.mn/new/ulaanbaatar/?page_id=46860 (직전 링크) → HTTP 200 인데
    ...
    //   · vet.gov.mn(GAVS) → 살아 있으나 이 증명서의 발급 창구가 아니다. 걸면 오안내다.
    //   링크를 되살릴 땐 위 셋의 현재 상태부터 다시 확인할 것.
  },
  {
