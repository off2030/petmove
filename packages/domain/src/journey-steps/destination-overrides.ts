...
> = {
  ...
  guam: {
    ...
    'general-vaccine': {
      ...
      description:
        '강아지는 DHLPP(디스템퍼·전염성간염·렙토스피라·파보바이러스·파라인플루엔자)와 켄넬코프(Bordetella), 고양이는 FVRCP(허피스·칼리시·범백혈구감소증)가 포함된 종합백신을 접종하세요.\n\n출국 10일 전까지 접종해야 해요.\n입국 때 면역 유효기간이 남아있어야 해요.',
      descriptionBySpecies: {
        dog: '강아지는 DHLPP(디스템퍼·전염성간염·렙토스피라·파보바이러스·파라인플루엔자)와 켄넬코프(Bordetella)가 포함된 종합백신을 접종하세요.\n\n출국 10일 전까지 접종해야 해요.\n입국 때 면역 유효기간이 남아있어야 해요.',
        cat: '고양이는 FVRCP(허피스·칼리시·범백혈구감소증)가 포함된 종합백신을 접종하세요.\n\n출국 10일 전까지 접종해야 해요.\n입국 때 면역 유효기간이 남아있어야 해요.',
      },
    ...
    'flight-purchase': {
      description:
        // 120일 안내는 **대만 수입 허가 카드와 같은 문형**(2026-07-27 사용자 지정) —
        //   "A까지 하세요 / 그 전에도 할 수 있지만, 이 경우 <대가>예요". 대만도 괌도
