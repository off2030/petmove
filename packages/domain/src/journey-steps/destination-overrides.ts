...
> = {
  ...
  south_africa: seaPermitOverrides({
    ...
    // ⛔ '마이크로칩 삽입 후에 접종해야 해요.' 를 되살리지 말 것(2026-07-30 원문 대조로 삭제).
    //   HA2123 증명서 A.1 은 칩 번호·위치 표와 "Microchip must be able to be read by ISO 11784
    //   or ISO 11785 scanners" 한 줄이 전부다 — 접종·채혈과의 **순서 조항이 없다**.
    //   EU(Reg 576/2013)와 달리 남아공은 칩 선행을 요구하지 않는다.
    rabiesDescription:
      '광견병 백신을 접종하세요.\n\n생후 3개월이 지난 후에 접종해야 해요.\n출국 30일 전까지 접종해야 해요.\n이전 접종의 유효기간 안에 추가접종하면 30일을 기다리지 않아도 돼요.\n면역 유효기간은 1년이에요. 2년·3년 백신은 인정되지 않아요.\n남아프리카공화국 출국 때 면역 유효기간이 남아있어야 해요.\n\n남아프리카공화국 입국에는 광견병 항체 검사가 필요하지 않아요.',
