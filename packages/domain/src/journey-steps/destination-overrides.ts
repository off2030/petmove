  ...
  thailand: {
    ...
    'general-vaccine': {
      ...
      descriptionBySpecies: {
        ...
        cat: '종합백신(FVRCP)을 접종하세요.\n\n범백혈구감소증(FPV) 예방을 반드시 포함해야 합니다.\n보통 접종하는 FVRCP 백신에는 범백혈구감소증(FPV)·허피스바이러스(FVR)·칼리시바이러스(FCV)가 함께 들어 있습니다.\n마이크로칩 삽입 후 접종합니다.\n입국 21일 전까지 접종해야 합니다.\n수입 허가 신청 2주 전까지 접종해야 합니다.\n입국 때 면역 유효기간이 남아있어야 합니다.\n\n수입 허가 신청에 접종 증명서와 백신 수첩이 필요합니다. 백신 수첩에는 모든 페이지에 마이크로칩 번호와 수의사의 서명 혹은 스탬프가 있어야 합니다.',
      },
    ...
    'flight-purchase': {
      description:
        '입국 가능 시기에 맞춰 항공권을 구매하세요.\n\n접종일로부터 21일이 지난 후에 입국할 수 있습니다.\n항공권 구매 후 수입 허가 신청을 합니다. 2주 이상 충분한 시간을 확보하세요.\n항공사에 반려동물 동반 가능 여부를 꼭 확인하세요.',
