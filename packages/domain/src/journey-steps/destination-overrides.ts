...
> = {
  ...
  south_africa: seaPermitOverrides({
    ...
    extra: {
      ...
      // 외부 기생충 치료 — 바베시아·리슈만편모충 매개체 차단(살진드기제 + 기피제). 출국 30일 이내.
      ...
      // 임상검사 — 출국 10일 이내(한국 별지 제25호와 같은 창)라 base 문구의 10일이 그대로
