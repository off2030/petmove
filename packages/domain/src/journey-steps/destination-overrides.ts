...
> = {
  ...
  philippines: {
    ...
    'flight-purchase': {
      description:
        '필리핀 입국 일정에 맞춰 항공권을 구매하세요.\n\n생후 120일(4개월)이 지나야 필리핀에 입국할 수 있어요.\n광견병 백신과 종합백신을 1회만 접종한 경우, 접종일로부터 21일이 지난 후에 입국할 수 있어요. (유효기간 안에 추가 접종을 한 경우는 대기 기간이 없어요.)\n수입 허가 신청에 항공편 일정이 필요해요. 늦어도 입국 2주 전까지 항공권을 준비하세요.\n항공사에 반려동물 동반 가능 여부를 꼭 확인하세요.',
