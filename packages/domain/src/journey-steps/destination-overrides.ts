...
> = {
  ...
  //   ⛔ **귀국 수출 카드 두지 않음 확정**(2026-07-23 사용자) — 베트남 복제 그룹과 동일. 아르헨티나
  //     출국엔 SENASA CVI(국제수의증명서)가 필요하나 검역소 방문이 아닌 EU식 건강증명서라, 넣는다면
  //     그룹(캄보디아·몽골·우즈벡·캐나다·베트남) 공통으로만 넣을 사안이다. 아르헨만 추가 금지.
  argentina: {
    'rabies-vaccine-1': buildRabiesCard({
      destKey: 'argentina',
      label: '아르헨티나',
