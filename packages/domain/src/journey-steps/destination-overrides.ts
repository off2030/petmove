...
> = {
  ...
  canada: {
    ...
    departure: importQuarantineCard({
      ...
      description:
        // 다른 나라 도착 카드와 같은 3줄로 축약(2026-07-21). CFIA 이관·접종 명령 같은 세부는
        // 빼고, 고객이 알아야 할 것(무엇을 확인하는지·격리 없음·수수료 현장 납부)만 남긴다.
        '캐나다 도착 후 국경에서 입국 심사를 받으세요.\n국경관리기관(CBSA)이 광견병 접종증명서와 반려동물 정보가 맞는지 확인하고, 건강 상태도 눈으로 봐요.\n캐나다는 입국 후 격리가 없어요. 검사 수수료는 현장에서 내야 해요.',
