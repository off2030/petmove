...
> = {
  ...
  turkey: {
    ...
    departure: importQuarantineCard({
      ...
      // 격리 21일 = 상업 사이트(PetTravel) 근거 — 1차 출처는 아니나 형제 카드(중국30·베트남14·대만7)와
      // 문형 통일 위해 표기(1차 확인 시 정정). 2026-07-23 재확인, 구 주석 '격리 규정 없음' 정정.
      description:
        '튀르키예 도착 후 공항 동물검역소에서 검역을 받으세요.\n마이크로칩과 서류를 확인해요. 준비에 문제가 없으면 격리 없이 통과할 수 있어요.\n입국 요건을 충족하지 못하면 지정 시설에서 21일간 격리되거나 한국으로 반송돼요.',
