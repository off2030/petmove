...
// 앱 지원 여행지(랜딩) — 접힘 5 + 더보기, 펼침 = 아시아 3 + EU 24 (앱 화이트리스트와 동일)
export const APP_DEST_PREVIEW = ['일본', '태국', '필리핀', '프랑스', '독일']
export const APP_DEST_ASIA = ['일본', '태국', '필리핀']
export const APP_DEST_EU = [
  '프랑스', '독일', '이탈리아', '스페인', '네덜란드', '벨기에', '오스트리아', '스웨덴',
  '덴마크', '폴란드', '체코', '포르투갈', '그리스', '헝가리', '루마니아', '불가리아',
  '크로아티아', '슬로바키아', '슬로베니아', '리투아니아', '라트비아', '에스토니아', '룩셈부르크', '키프로스',
]
export const APP_DEST_SOON = ['하와이', '싱가포르', '중국', '대만', '미국', '캐나다', '영국', '인도네시아', '말레이시아', '호주', '뉴질랜드']
