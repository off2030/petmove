...
// 앱 지원 여행지(랜딩) — 접힘 5 + 더보기, 펼침 = 아시아 4 + 유럽 30 (총 34개국, 앱 화이트리스트와 동일).
...
export const APP_DEST_ASIA = ['일본', '중국', '태국', '필리핀']
...
export const APP_DEST_SOON = ['하와이', '싱가포르', '대만', '미국', '캐나다', '인도네시아', '말레이시아', '호주', '뉴질랜드']
