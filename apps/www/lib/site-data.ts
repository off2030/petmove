...
// 앱 지원 여행지(랜딩) — 접힘 5 + 더보기, 펼침 = 아시아 9 + 유럽 30 + 아메리카 1 (총 40개국,
// 앱 화이트리스트와 동일).
...
// 2026-07-20 기준 domain appSupported 18건 = japan·china·taiwan·vietnam·thailand·philippines·
//   cambodia·mongolia·uzbekistan (아시아 9) + eu·uk·ireland·malta·norway·finland·cyprus·switzerland
...
export const APP_DEST_ASIA = [
  '대만', '몽골', '베트남', '우즈베키스탄', '일본', '중국', '캄보디아', '태국', '필리핀',
]
...
// 아메리카 — 2026-07-20 캐나다 지원 시작(APP_DEST_SOON 에서 승격).
export const APP_DEST_AMERICA = ['캐나다']
