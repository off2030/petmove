      ...
      <div ref={containerRef} className="relative min-w-0 flex flex-col md:flex-row items-start gap-md">
        ...
        {open && popupPos && typeof document !== 'undefined' && createPortal(
          <div
            ...
            className="z-50 flex flex-col rounded-md border border-muted-foreground/80 bg-background shadow-md overflow-hidden"
          >
            <div className="shrink-0 p-2 border-b border-border/30">
              <input
                ...
                className="w-full h-8 rounded border border-muted-foreground/80 bg-background px-2 text-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring/30"
              />
            </div>
