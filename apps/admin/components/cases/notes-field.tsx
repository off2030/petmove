  ...
  return (
    <div className="flex items-start gap-sm flex-1 min-w-0">
      <textarea
        ...
        className="flex-1 min-w-0 min-h-[2rem] rounded-md border border-muted-foreground/80 bg-background p-2 text-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring/30 resize-none"
      />
      <button
        type="button"
