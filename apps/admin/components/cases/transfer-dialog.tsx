        ...
        <div className="px-lg py-md">
          ...
          {picked ? (
            ...
            <div className="relative mt-1">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 rounded-md border border-muted-foreground/80 bg-background font-serif text-[15px] focus:outline-none focus:border-foreground/40"
              />
          ...
          <label className="block mt-md">
            ...
            <textarea
              ...
              className="mt-1 w-full px-3 py-2 rounded-md border border-muted-foreground/80 bg-background font-serif text-[14px] resize-none focus:outline-none focus:border-foreground/40"
            />
          </label>
