...
function AmountInput({ initial, onSave, onCancel, saving }: {
  ...
  return (
    <input
      ...
      placeholder="금액"
      className="w-28 h-8 rounded-md border border-muted-foreground/80 bg-background px-2 text-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring/30"
    />
  )
}
