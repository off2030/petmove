  ...
  return (
    <span className="inline-flex items-center gap-1">
      <input ref={ref} type="text" value={val}
        ...
        className="w-28 h-7 rounded-md border border-muted-foreground/60 bg-background px-2 text-xs focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring/30"
      />
      {onClearAuto && (
        <button
          type="button"
