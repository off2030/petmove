          ...
          <section className="space-y-md">
            ...
            <label className="block max-w-[180px]">
              ...
              <select
                ...
                className="mt-1 w-full px-3 py-2 rounded-md border border-muted-foreground/80 bg-background font-serif text-[14px] focus:outline-none focus:border-foreground/40"
              >
