...
function ValueInput({ initial, onSave, onCancel, saving }: {
  ...
  return (
    <input ref={ref} type="text" inputMode="decimal" value={val}
      ...
      placeholder="수치"
      className="w-24 h-8 rounded-md border border-muted-foreground/40 bg-background px-2 text-sm focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring/30"
    />
  )
}
