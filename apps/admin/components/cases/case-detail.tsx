...
function MicrochipField({ caseId, caseRow, spec }: { caseId: string; caseRow: CaseRow; spec: FieldSpec }) {
  ...
  const inputCls = 'w-52 h-8 rounded-md border border-muted-foreground/60 bg-background px-2 text-sm font-mono tracking-[0.3px] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring/30'
