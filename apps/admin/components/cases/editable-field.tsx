      ...
      {isSelect ? (
        ...
        <div className="relative" ref={selectWrapRef}>
          ...
          {editMode && editing && selectPopupPos && typeof document !== 'undefined' && createPortal(
            <ul
              ...
              className="z-50 w-max max-w-[400px] overflow-y-auto rounded-md border border-muted-foreground/80 bg-background py-1 shadow-md scrollbar-minimal"
            >
        ...
        <div className="flex items-start gap-sm">
          <PhoneInput
            ...
            onBlur={handleBlur}
            className="flex-1 h-8 rounded-md border border-muted-foreground/80 bg-background px-2 text-base focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring/30"
          />
          <button
            type="button"
      ...
      <>
        ...
        <div className="inline-flex items-baseline gap-1 min-w-0 basis-full md:basis-auto">
          ...
          <input
            ...
            className="flex-1 min-w-0 h-7 rounded-md border border-muted-foreground/80 bg-background px-2 font-mono text-[12px] tracking-[0.5px] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring/30"
          />
          <button
            type="button"
            onMouseDown={(e) => e.preventDefault()}
...
function renderInput(
  ...
  const commonClass = inline
    ...
    : 'flex-1 h-8 rounded-md border border-muted-foreground/80 bg-background px-2 text-base focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring/30'
    ...
    return (
      <textarea
        ...
        className={inline
          ...
          : 'flex-1 min-h-[4.5rem] rounded-md border border-muted-foreground/80 bg-background p-2 text-base focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring/30 resize-y'}
      />
    )
  }
