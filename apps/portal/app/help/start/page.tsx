...
const STEPS: { title: string; paras: string[] }[] = [
  {
    title: '펫무브 등록',
    paras: [
      "가입 후 '시작하기'를 누르고 여행, 반려동물, 보호자 정보를 등록해주세요. 이 정보는 검역에 사용되는 필수 정보예요. 등록 후에는 '내 정보' 탭에서 확인·수정하실 수 있어요.",
    ],
  },
  {
    ...
    paras: [
      ...
      '카드를 누르면 자세한 설명을 볼 수 있어요. 카드의 종류에 따라 날짜를 입력하고 저장 버튼을 누르거나 바로 완료 버튼을 눌러서 해당 단계를 완료 표시할 수 있어요.',
