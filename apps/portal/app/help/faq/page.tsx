...
const FAQS: { q: string; a: ReactNode }[] = [
  {
    q: '이용료가 있나요?',
    a: '현재 앱의 모든 기능을 무료로 사용할 수 있어요. 전문가에게 맡기는 대행 서비스는 별도 상담 후 진행돼요.',
  },
  {
    q: '병원에 이미 준비를 의뢰했는데, 앱에서도 볼 수 있나요?',
    a: (
      <>
        네. 병원에 알려주신 이메일과 같은 이메일로 로그인하면 준비 중인 내용이 자동으로
        연결돼요. 연결되지 않으면 {supportLink}으로 문의해 주세요.
      </>
    ),
  },
  {
    q: '여러 마리를 함께 준비할 수 있나요?',
    a: "네. '내 정보' 탭 > '동물 추가'로 각각 등록하면 동물마다 일정이 따로 관리돼요. '준비'·'서류' 화면에서 좌우로 넘기면 동물을 전환할 수 있어요.",
  },
  {
    q: '어느 나라를 지원하나요?',
    a: '일본, 유럽 전역, 미국을 비롯한 주요 목적지를 지원해요. 목적지 선택 화면에서 전체 목록을 확인할 수 있어요.',
  },
  {
    q: '출국까지 얼마나 걸리나요?',
    a: '나라마다 달라요. 광견병 항체검사 후 대기 기간이 있는 나라는 오래 걸려요(일본 180일, 유럽 3개월 등). 여행이 정해지면 바로 준비를 시작하는 것이 안전해요.',
  },
  {
    q: '날짜를 잘못 입력했어요.',
    a: '해당 단계 카드를 다시 열어 수정하면 이후 일정이 자동으로 다시 계산돼요.',
  },
  {
    q: '입력이 안 되는 날짜가 있어요.',
    a: '검역 규정상 불가능한 날짜(예: 접종 전에 채혈)는 자동 검증 기능이 입력을 제한해요. 규정과 다르게 기록해야 할 특별한 사정이 있다면 설정 > 고급에서 자동 검증 기능을 끌 수 있어요. 안전한 준비를 위해서는 켜두시는 게 좋아요.',
  },
  {
    q: '알림은 어떻게 받나요?',
