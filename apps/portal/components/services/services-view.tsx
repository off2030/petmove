...
const THAILAND_REVIEWS: Review[] = [
  {
    ...
    name: '이○연님',
    meta: '망고 · 태국',
    text: '원장님 안녕하세요~ 망고 데리고 치앙마이 잘 도착해서 짐 풀고 이제야 카톡 드려요. ^^ 고양이라 비행기 안에서 예민하게 굴까 봐 걱정이 참 많았는데, 상담해 주신 대로 스트레스 줄이는 약을 처방받아 준비했더니 기내에서 얌전히 잘 와주었어요. 태국 검역소에서도 챙겨주신 서류 그대로 내니까 쓱 훑어보고 바로 통과시켜 주더라고요. 원장님 덕분에 마음 편하게 왔어요. 정말 감사합니다!',
  },
  {
    initial: '보',
    name: '김○수님',
    meta: '보리 · 태국',
    text: '원장님 안녕하세요! 방콕으로 이주하면서 보리 입국 서류 때문에 막막했는데, 원장님 덕분에 무사히 잘 도착했습니다. 수입허가서 발급이랑 접종 스케줄 짜는 건 저 혼자선 도저히 엄두가 안 났을 거예요. 챙겨주신 대로 준비해 갔더니 현지 공항 검역소에서 질문 하나 없이 바로 통과했어요. 대형견이라 더 걱정했는데 덕분에 마음이 든든했습니다. 진심으로 감사드려요!',
  },
  {
    initial: '콩',
    name: '박○훈님',
...
const PHILIPPINE_REVIEWS: Review[] = [
  {
    ...
    name: '정○우님',
    meta: '호두 · 필리핀',
    text: '원장님 안녕하세요, 호두 보호자입니다. 갑작스럽게 클락으로 발령이 나는 바람에 검역 준비 시간이 너무 촉박해서 눈앞이 깜깜했어요. 규정이 까다로워 아이를 두고 가야 하나 진지하게 고민했을 정도였거든요. 그런데 제 출국 날짜에 맞춰 접종이랑 서류 발급 일정을 기가 막히게 짜주셨어요. 출국 전날 마지막 서류 점검 때 “이대로만 내시면 아무 문제 없습니다” 하셨는데, 클락 공항에 도착해보니 정말 그 말씀대로였어요. 꼼꼼히 챙겨주셔서 정말 감사합니다.',
  },
  {
    initial: '루',
    name: '최○진님',
    meta: '루나 · 필리핀',
    text: '원장님 안녕하세요~ 루나 데리고 세부에 입국해서 짐 정리하다가 이제야 인사 드려요. 루나가 워낙 예민한 고양이라 병원 갈 때부터 걱정이 많았는데, 검진 조심스럽게 잘 해주시고 안심시켜 주셔서 너무 감사했어요. 광견병이랑 예방접종 증명서를 깐깐하게 본다고 들었는데, 챙겨주신 서류 그대로 검역소에 내니까 질문 하나 없이 패스였어요! 원본이랑 사본 헷갈리지 않게 다 분류해 주셔서 정말 편했습니다. 감사해요!',
  },
  {
    initial: '초',
    name: '박○훈님',
    meta: '초코 · 필리핀',
    text: '원장님, 초코네 마닐라 무사히 도착했습니다! 수입허가서 받는 과정이 워낙 복잡하고 빠꾸도 잘 난다고 해서 걱정이 태산이었는데, 혼자 했으면 출국 전날까지 피 말렸을 것 같아요. 초코 접종 스케줄부터 수입허가서랑 출국 건강증명서까지 날짜를 딱딱 맞춰 준비해 주신 덕분에 금방 통과했어요. 원장님 정말 감사합니다!',
  },
]
