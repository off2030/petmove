...
const THAILAND_REVIEWS: Review[] = [
  {
    ...
    name: '박○훈님',
    meta: '콩이 · 태국',
    text: '급하게 결정이 되어 콩이 검역 준비 일정이 빠듯했는데, 바로 예약 잡아주시고 빠르게 진행해주셔서 정말 감사했어요. 태국은 서류 하나만 잘못돼도 입국이 거절될 수 있다고 해서 긴장했는데, 챙겨주신 서류만 들고 가니 당황할 일 없이 수월하게 입국했습니다. 진심으로 감사드려요!',
  },
  {
    initial: '망',
    name: '이○연님',
    meta: '망고 · 태국',
    text: '고양이라 비행기 안에서 예민하게 굴까 봐 걱정이 참 많았는데, 출국 전 검진 때 상담해 주신 대로 스트레스 줄이는 약을 처방받아 준비했더니 기내에서 얌전히 잘 와주었어요. 태국 현지 검역소에서도 챙겨주신 서류 그대로 훑어보고 바로 통과시켜 주더라고요. 동물검역 규정이 수시로 바뀐다던데, 전문가에게 맡기길 잘했다는 생각이 들었어요. 정말 감사합니다!',
  },
  {
    initial: '보',
    name: '김○수님',
    meta: '보리 · 태국',
    text: '방콕으로 이주하면서 태국 입국 서류 때문에 막막했는데, 덕분에 무사히 잘 도착했습니다. 수입허가서 발급이랑 규정에 맞춰 접종 스케줄을 짜는 건 혼자선 도저히 엄두가 안 나더라고요. 완벽하게 준비해 주신 덕분에 현지 공항 동물검역소에서 질문 하나 없이 바로 통과했습니다. 대형견이라 더 걱정했는데 마음이 든든했어요. 진심으로 감사드립니다!',
  },
]
