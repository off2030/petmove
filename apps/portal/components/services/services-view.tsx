...
const PHILIPPINE_REVIEWS: Review[] = [
  {
    ...
    name: '정○우님',
    meta: '호두 · 필리핀',
    text: '갑작스럽게 클락으로 발령이 나는 바람에 호두 검역 준비 시간이 너무 촉박해서 눈앞이 깜깜했어요. 인터넷을 찾아보니 규정이 까다로워 반려견을 두고 가야 하나 진지하게 고민했는데, 제 출국 날짜에 맞춰 접종이랑 서류 발급 일정을 기가 막히게 짜주셨습니다. 출국 전날 병원에서 마지막 서류 점검을 받을 때 “이대로만 내시면 아무 문제 없습니다” 하셨는데, 클락 공항에 도착해보니 정말 그 말씀이 맞았어요. 완벽한 서류 준비 정말 감사합니다.',
  },
  {
    initial: '루',
    name: '최○진님',
  ...
  },
  {
    ...
    name: '박○훈님',
    meta: '초코 · 필리핀',
    text: '초코네 마닐라 무사히 도착했습니다! 수입허가서를 받는 과정이 워낙 복잡하고 빠꾸도 잘 난다고 해서 걱정이 태산이었거든요. 혼자 하려고 했으면 출국 전날까지 피 말렸을 것 같아요. 초코 접종 스케줄부터 수입허가서랑 출국 건강증명서까지 날짜를 딱딱 맞춰 완벽하게 준비해 주신 덕분에 금방 통과했습니다. 감사합니다!',
  },
]
