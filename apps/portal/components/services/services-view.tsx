...
const THAILAND_REVIEWS: Review[] = [
  {
    ...
    name: '이○연님',
    meta: '망고 · 태국',
    text: '고양이라 비행기 안에서 예민하게 굴까 봐 걱정이 참 많았는데, 상담해 주신 대로 스트레스 줄이는 약을 처방받아 준비했더니 기내에서 얌전히 잘 와주었어요. 태국 현지 검역소에서도 챙겨주신 서류 그대로 훑어보고 바로 통과시켜 주더라고요. 동물검역 규정이 수시로 바뀐다던데, 전문가에게 맡기길 잘했다는 생각이 들었어요. 정말 감사합니다!',
  },
  {
    initial: '보',
    name: '김○수님',
