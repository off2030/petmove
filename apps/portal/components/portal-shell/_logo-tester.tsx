...
const VARIANTS: Variant[] = [
  { name: 'ribbon-p-amber', svg: '<rect width="100" height="100" rx="22.5" fill="#d99a58"/><path d="M34 80 C 28 62, 29 42, 41 31 C 53 23, 68 28, 68 43 C 68 55, 57 60, 49 56 C 43 53, 43 47, 48 45" fill="none" stroke="#ffffff" stroke-width="9.5" stroke-linecap="round" stroke-linejoin="round"/>' },
