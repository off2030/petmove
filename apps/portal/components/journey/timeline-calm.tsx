...
const DEST_PHOTO_CANDIDATES: Record<string, string[]> = {
  ...
  // 홍콩 — 2026-07-26 등록(22장 중 10장). 01~05·07~11·15·21 삭제(사용자 지정) — 결번 유지(재번호 X).
  // 리드(첫 장) = hongkong-14(빅토리아 피크 야경) — 2026-07-26 사용자 지정.
  // 나머지는 파일 순서 유지(buildHeroPhotoState 가 첫 장 고정 + 나머지 셔플).
  홍콩: [
    '/destinations/hongkong-14.jpg',
    '/destinations/hongkong-06.jpg',
    '/destinations/hongkong-12.jpg',
    '/destinations/hongkong-13.jpg',
    '/destinations/hongkong-16.jpg',
    '/destinations/hongkong-17.jpg',
  ...
  하와이: [
    // 사용자 선별 Unsplash 15장(노트북 목적지별 사진/하와이 폴더와 동일 원본) — 파일명 abc순.
    '/destinations/hawaii-01.webp',
    '/destinations/hawaii-02.webp',
    '/destinations/hawaii-03.webp',
    '/destinations/hawaii-04.webp',
    '/destinations/hawaii-05.webp',
    '/destinations/hawaii-06.webp',
    '/destinations/hawaii-07.webp',
    '/destinations/hawaii-08.webp',
    '/destinations/hawaii-09.webp',
    '/destinations/hawaii-10.webp',
    '/destinations/hawaii-11.webp',
    '/destinations/hawaii-12.webp',
    '/destinations/hawaii-13.webp',
    '/destinations/hawaii-14.webp',
  ],
  괌: [
    // 사용자 선별 Unsplash 5장(목적지별 사진/괌 폴더 원본).
    // 리드(첫 장) = guam-03(에메랄드 바다·백사장 항공샷) — 2026-07-26 사용자 지정.
    // 나머지는 파일명 abc순 유지(미국 usa-14 리드 지정과 같은 방식).
  ...
  남아프리카공화국: [
    ...
    '/destinations/southafrica-07.webp',
    '/destinations/southafrica-08.webp',
          ...
          >
            ...
            >
              {hasWarn ? (
                ...
                // ⛔ 여기에 '예정' 폴백을 되돌리지 말 것(2026-07-30 사용자 '버그' 지적).
                //   'current 인데 붙일 날짜·주의·안내가 없을 때' 쓰던 라벨인데, 뜻이
                //   "지금 할 차례"이지 "일정이 잡혀 있다"가 아니다. 날짜가 비어 있는데
                //   '예정'이라 쓰면 보호자는 뭔가 예약된 것으로 읽는다.
                //   current 는 이미 **파란 번호 배지**와 상단 '다음 할 일' 카드로 드러나므로
                //   이 자리는 날짜가 있을 때만 채운다(없으면 다른 미완료와 같이 '—').
                //   호주에서 세 장(전염병 검사·외부구충·내부구충)을 동시 노출하게 되면서
                //   날짜 없는 '예정'이 한 화면에 여러 개 뜨며 드러났다.
                formatStageDate(s)
              )}
            </div>
          </div>
