  ...
  <section id="service" style="background:var(--surface);border-top:0.5px solid var(--border);border-bottom:0.5px solid var(--border)">
    <div class="container">
      ...
      <div class="score-list">
        <div class="score">
          <div class="score-h"><svg class="si" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 20l-7.5 -7.428a5 5 0 1 1 7.5 -6.566a5 5 0 0 1 8.785 4.444" stroke="#E5484D"/><path d="M16 19h6" stroke="#212124"/><path d="M19 16v6" stroke="#212124"/></svg><span class="st">로잔동물의료센터</span></div>
