...
<style>
  ...
  *{{box-sizing:border-box}}
  ...
  header{{position:sticky;top:0;z-index:20;background:rgba(244,246,248,.92);backdrop-filter:blur(8px);
  ...
  .final .clouds{{display:block;width:100%;height:84px;margin-top:40px}}
...
{SERVICE_SECTION}
  ...
  <div class="final">
    ...
    <svg class="clouds" viewBox="0 0 1440 120" preserveAspectRatio="xMidYMax slice" aria-hidden="true"><rect y="96" width="1440" height="24" fill="#fff"/><circle cx="40" cy="116" r="46" fill="#fff"/><circle cx="128" cy="102" r="64" fill="#fff"/><circle cx="222" cy="116" r="46" fill="#fff"/><circle cx="424" cy="112" r="52" fill="#fff"/><circle cx="506" cy="100" r="68" fill="#fff"/><circle cx="596" cy="114" r="48" fill="#fff"/><circle cx="784" cy="114" r="44" fill="#fff"/><circle cx="856" cy="102" r="60" fill="#fff"/><circle cx="938" cy="114" r="46" fill="#fff"/><circle cx="1140" cy="112" r="54" fill="#fff"/><circle cx="1226" cy="100" r="68" fill="#fff"/><circle cx="1322" cy="114" r="50" fill="#fff"/><circle cx="1420" cy="118" r="42" fill="#fff"/></svg>
  </div>
