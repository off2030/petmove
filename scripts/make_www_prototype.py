...
APP_SECTIONS = f"""
  <section>
    <div class="container">
      ...
      <div class="alist">
        <div class="acard"><div class="acard-h"><span class="ai"><i class="ti ti-route"></i></span><span class="at">단계별 가이드</span></div><p class="ad">목적지에 따라 언제 무엇을 해야 할지 알려드려요</p></div>
        <div class="acard"><div class="acard-h"><span class="ai"><i class="ti ti-shield-check"></i></span><span class="at">실수 예방</span></div><p class="ad">입력 정보를 기반으로 규정에 맞지 않을 경우 알려드려요</p></div>
        <div class="acard"><div class="acard-h"><span class="ai"><i class="ti ti-bell"></i></span><span class="at">일정 알림</span></div><p class="ad">접종·검사 유효기간 만료, 신청 기한 마감, 예정일을 알려드려요</p></div>
        ...
        <div class="acard"><div class="acard-h"><span class="ai"><i class="ti ti-folder"></i></span><span class="at">보관함</span></div><p class="ad">백신 라벨·증명서·수입허가증 등 이미지·PDF를 보관할 수 있어요</p></div>
