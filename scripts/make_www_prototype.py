...
# 본뜬 것이었음 — 원본 실사로 회귀. shutterstock 라이선스 구매 완료(2026-07-15 사용자 확인).
  ...
  <section>
    <div class="container">
      ...
      <div class="alist">
        ...
        <div class="acard"><div class="acard-h"><span class="ai"><i class="ti ti-shield-check"></i></span><span class="at">실수 예방</span></div><p class="ad">입력 정보가 규정에 맞지 않으면 알려드려요</p></div>
        <div class="acard"><div class="acard-h"><span class="ai"><i class="ti ti-bell"></i></span><span class="at">일정 알림</span></div><p class="ad">예정일·만료일·마감일을 놓치지 않게 알려드려요</p></div>
      ...
      <div class="appcta-wrap"><a class="appcta" href="#download"><i class="ti ti-download"></i>무료 앱 받기</a></div>
    </div>
  </section>
"""
  ...
  <section id="service">
    <div class="container">
      ...
      <div class="score-list">
        <div class="score">
          <div class="score-h"><i class="ti ti-heart-plus si" style="color:#E9A800"></i><span class="st">로잔동물의료센터</span></div>
          <p class="sd">수의사가 직접 준비해 믿고 맡길 수 있어요</p>
        </div>
        <div class="score">
          <div class="score-h"><i class="ti ti-device-mobile si" style="color:#E9A800"></i><span class="st">펫무브 앱 연동</span></div>
...
<style>
  ...
  *{{box-sizing:border-box}}
  ...
  #service,#download{{scroll-margin-top:64px}}
...
<body>
  <header>
    <div class="container">
      ...
      <span class="nav-right">
        <a class="nav-app" href="#download">앱 다운로드</a>
  ...
  <aside class="drawer" id="drawer">
    ...
    <a class="drawer-app" href="#download">앱 다운로드</a>
  </aside>
    ...
    <div class="scrim">
      <div class="container">
        <div class="hero-content">
          ...
          <div class="cta">
            <a class="btn-primary" href="#download"><i class="ti ti-download" style="font-size:17px"></i>무료 앱으로 시작하기</a>
...
{SERVICE_SECTION}
  ...
  <div class="final" id="download">
    <div class="container">
      <h2>무료 앱으로 시작하세요</h2>
      <div class="store-row">
        <a class="store" href="https://apps.apple.com/kr/app/id6784567864" target="_blank" rel="noopener"><i class="ti ti-brand-apple" style="font-size:18px"></i>App Store</a>
        <a class="store" href="https://play.google.com/store/apps/details?id=com.petmove.portal" target="_blank" rel="noopener"><i class="ti ti-brand-google-play" style="font-size:16px"></i>Google Play</a>
      </div>
    </div>
...
(function(){{
  ...
  document.querySelectorAll('.nav-app,.drawer-app,.appcta,a.btn-primary[href="#download"]').forEach(function(a){{
