...
def build_article_sample():
    """실제 라이브 일본 가이드 전문을 템플릿에 부어넣은 미리보기."""
    C = "http://pf.kakao.com/_zDDxhj/chat"
...
{header('guide')}
  <article class="article">
    ...
    <div class="art-head">
      ...
      <div class="art-meta">마지막 업데이트 2026.01 · 읽는 데 약 12분</div>
    </div>
    <div class="prose">
      <img class="art-cover" src="https://storage.ghost.io/c/61/a2/61a2ac22-42e3-487b-9a3b-d0ed58d1ec8a/content/images/size/w1600/2026/01/japan-pet-travel-cover.webp" alt="일본 입국 준비 총정리">
      ...
      <h3>외장형 마이크로칩이 있는데 꼭 내장형을 해야 하나요?</h3>
      ...
      <p>크게 마이크로칩 스캔이 되지 않는 경우, 마이크로칩 번호가 다른 경우, 마이크로칩이 두 개인 경우로 나누어 볼 수 있습니다. 대부분은 반복된 스캔으로 예방할 수 있어, <strong>매 단계마다 마이크로칩을 스캔해 반복 확인</strong>하면 사전에 발견·해결할 수 있습니다.</p></div></details>
      ...
      <ul>
        ...
        <li>⚠️ 일본 입국 때 면역유효기간이 남아 있어야 하며, 끝나기 전 재접종하면 연장 가능</li>
      </ul>
      <details class="more"><summary><span>더 자세한 설명</span><i class="ti ti-chevron-down"></i></summary><div class="more-body">
      <h3>광견병 예방접종은 언제 해야 하나요?</h3>
      <p>일본 입국을 위해서는 광견병 예방접종을 2번 해야 합니다. 마이크로칩 이식 후 30일 이상 간격으로 접종하며, 두 번째 접종은 첫 번째 접종의 면역 유효기간 안에 실시해야 합니다. 강아지 나이가 91일령 이상이어야 하는 점도 주의해 주세요.</p>
      <blockquote>💡 최적의 접종 타이밍 — <strong>마이크로칩 이식 + 광견병 1차(동시)</strong> → 30일 대기 → <strong>광견병 2차 + 항체검사(동시)</strong>. 병원 방문을 최소화하면서 가장 빠르게 준비를 마칠 수 있어요.</blockquote>
      <h3>오래전 광견병 예방접종을 한 적이 있어요. 그래도 2회가 필요한가요?</h3>
      <p>이전에 접종했어도 면역유효기간이 지났다면 2회 접종을 해야 합니다. 유효기간이 남았더라도 증명서 발행에 필요한 백신 상세 정보가 없다면 2회 접종이 필요합니다.</p></div></details>
      ...
      <ul>
        ...
        <li>0.5 IU/㎖ 이상일 경우 통과</li>
        <li>유효기간 2년(⚠️ 백신 면역유효기간이 지나면 자동 종료)</li>
      </ul>
      <details class="more"><summary><span>더 자세한 설명</span><i class="ti ti-chevron-down"></i></summary><div class="more-body">
      <h3>광견병항체검사는 언제 하나요?</h3>
      <p>마이크로칩 이식과 광견병 예방접종 2회를 마친 후 실시합니다. 2차 접종과 같은 날 검사도 가능합니다. <strong>검사 채혈일로부터 180일이 지나야 일본에 갈 수 있어</strong>, 일본 여행 180일 전에는 검사를 마쳐야 합니다.</p>
      <h3>합격 기준은 어떻게 되나요?</h3>
      <p>합격 기준은 0.5 IU/㎖ 입니다. 이 수치보다 높으면 입국이 가능합니다. 불합격인 경우 합격이 될 때까지 접종과 검사를 반복할 수 있습니다.</p></div></details>

      <div class="callout">
        <div class="ch"><i class="ti ti-device-mobile"></i>펫무브 앱으로 자동 관리</div>
        <p class="cp">칩 이식일·접종일·항체검사 채혈일만 입력하면, 앱이 <strong>180일 대기 만료일</strong>과 다음에 할 일을 자동으로 알려줘요.</p>
        <a class="cbtn" href="prototype-mobile.html">무료 앱으로 준비하기 ›</a>
      </div>

      <h2>대기기간(180일)</h2>
      <ul>
        <li>광견병 항체검사 채혈일로부터 180일 경과 후 일본 입국 가능(채혈일을 0일로 계산)</li>
        <li>일본 도착일은 '광견병 백신 면역유효기간'과 '항체검사 유효기간' 이내여야 함</li>
      </ul>
      ...
      <ul>
        ...
        <li>입국 공항 또는 항구 동물검역소에 신고(일본어 事前届出 / advance notification)</li>
        <li>일본 동물검역소 웹사이트(NACCS) 또는 이메일로 신고</li>
        <li>완료되면 허가증(Approval) 발급</li>
      </ul>
      <details class="more"><summary><span>더 자세한 설명</span><i class="ti ti-chevron-down"></i></summary><div class="more-body">
      <h3>사전 신고가 뭔가요?</h3>
      <p>어느 날짜에, 어느 공항(항구)으로, 어떤 반려동물을 데려가는지 일본 동물검역소에 미리 알리고 준비에 문제가 없는지 사전 검토를 받는 절차입니다. 일본 입국을 위한 필수 절차입니다.</p>
      <h3>사전 신고는 언제 해야 하나요?</h3>
      <p>입국 최소 40일 전까지 해야 합니다. 처음이면 시간이 오래 걸릴 수 있어 최소 2달 전 준비 시작을 권장합니다. 정확한 항공편 정보가 필요하므로 항공권 구매도 미리 하셔야 합니다.</p></div></details>

      <h2>일본 수출동물검역 신청</h2>
      <ul>
        <li>짧은 여행 등 한국 귀국 일정이 있는 경우 필수</li>
        <li>귀국일 기준 최소 10일 전 신청</li>
      ...
      <ul>
        <li>출국 전 10일 이내, 동물병원에서 실시</li>
        <li>마이크로칩 스캔 및 임상 검사(전염병 징후 체크)</li>
        <li>⚠️ 임상검사를 한 동물병원에서 최종 증명서류를 준비</li>
      </ul>
      <blockquote>⚠️ 각 절차를 서로 다른 병원에서 하면 증명서 비용 증가·정보 불일치·오류 가능성이 커져요. <strong>마이크로칩부터 모든 절차를 한 동물병원에서</strong> 진행하면 한 장의 증명서로 정리돼 오류가 적고 문제 해결도 쉬워요.</blockquote>

      <h2>수출동물검역</h2>
      <ul>
        <li>출국 전 10일 이내, 각 지역 동물검역소에서 실시</li>
        <li>검역 통과 시 <strong>수출검역증명서</strong> 발급</li>
        <li>⚠️ 출발 당일 공항 검역도 가능하나, 안전을 위해 사전 검역 권장</li>
      </ul>
      ...
      <ul>
        ...
        <li>입국 가능 공항: 나리타(NRT)·간사이(KIX)·하네다(HND)·추부(NGO)·삿포로(CTS) 등 검역소가 있는 공항</li>
        <li>⚠️ 도착 후 별도 안내가 없으니 소유주가 직접 동물검역소를 찾아가야 함</li>
      </ul>
      <details class="more"><summary><span>더 자세한 설명</span><i class="ti ti-chevron-down"></i></summary><div class="more-body">
      <h3>일본에서 귀국할 때는 어떻게 하나요?</h3>
      <p>귀국 시에도 일본 동물검역소에서 수출 검역을 받아야 합니다. 현재는 예약제로 운영되므로 반드시 사전에 신청·예약해야 합니다. 한국 도착 후에는 농림축산검역본부에 수출국 검역증명서 원본과 항체검사 결과지를 제출합니다. 일본은 광견병 비발생국이라 한국 입국 시 항체가 검사는 면제됩니다.</p></div></details>
    </div>

    <div class="callout">
      <div class="ch"><i class="ti ti-calculator"></i>준비 일정 계산이 어렵다면</div>
      <p class="cp">펫무브 <a href="https://www.petmove.co.kr/blog/japan-pet-entry-scheduler/" target="_blank" rel="noopener" style="color:var(--accent-ink);font-weight:600">일본 입국 일정 계산기</a>로 날짜를 자동 계산하고, <a href="https://www.petmove.co.kr/blog/japan-pet-entry-self-check/" target="_blank" rel="noopener" style="color:var(--accent-ink);font-weight:600">자가진단(Self-Check)</a>으로 맞게 준비 중인지 확인해 보세요.</p>
    </div>

    <div class="art-cta">
      <h3>일본 여행, 펫무브(로잔동물의료센터)에서 준비하세요</h3>
      <p>수의사가 직접 준비해 드려요. 지금 바로 상담·예약하세요.</p>
      <a href="{C}" target="_blank" rel="noopener">상담·예약하기</a>
    </div>

    <div class="related">
      <div class="rl-h">관련 글</div>
      ...
      <a href="https://www.petmove.co.kr/blog/gangaji-simjangsusuleul-wihan-ilbon-ibgug-junbi-annae/" target="_blank" rel="noopener">강아지 심장수술을 위한 일본 입국 준비 <i class="ti ti-chevron-right"></i></a>
      <a href="https://www.petmove.co.kr/blog/gangajireul-derigo-hanguggwa-ilboneul-yeoreobeon-wangboghaneun-gyeongu/" target="_blank" rel="noopener">한국과 일본을 여러 번 왕복해야 하는 경우 <i class="ti ti-chevron-right"></i></a>
      <a href="https://www.petmove.co.kr/blog/ilbon-juyo-gonghang-dongmulgeomyeogso-wici/" target="_blank" rel="noopener">일본 주요 공항 동물검역소 위치 <i class="ti ti-chevron-right"></i></a>
    </div>
  </article>
