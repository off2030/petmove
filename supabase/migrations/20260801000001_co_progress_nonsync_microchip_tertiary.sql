-- =============================================================================
-- 보조 마이크로칩 2번째 키(microchip_tertiary)를 co_progress 동기화 제외에 추가.
--
-- 배경: 보조칩을 2개까지 입력할 수 있게 확장 (2026-08-01). 칩 번호는 동물 개체
-- 식별자라 형제 케이스로 전파되면 안 된다 — microchip_secondary 는 이미
-- nonsync_keys 에 있었고, 새 키 microchip_tertiary 도 동일하게 제외한다.
-- 나머지 로직은 20260725000001(기본 OFF)과 동일.
-- =============================================================================
